// packages/lfp-type-compiler/src/policy/rules/no-imperative-branching.ts
...
export const noImperativeBranchingRule: Rule = {
  meta: {
    ...
    defaultOptions: {},
    description: "Prefer Result/Option combinators over imperative if/else branching for functional composition.",
  },
