...
if (!result1.ok) {
  ...
  result1.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
...
if (!result2.ok) {
  ...
  result2.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
...
if (!result3.ok) {
  ...
  result3.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
...
if (!result4.ok) {
  ...
  result4.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
...
if (!result5.ok) {
  ...
  result5.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
...
if (!result6.ok) {
  ...
  result6.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
...
if (!result7.ok) {
  ...
  result7.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
...
if (result8.ok) {
  ...
  result8.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
}

// Test 9: Complex nested structure
console.log("\nTest 9: Complex nested structure");
const complexSchema = enc.obj([
  { name: "users", type: enc.arr(enc.obj([
    { name: "id", type: enc.num() },
    { name: "profile", type: enc.obj([
      { name: "name", type: enc.str() },
...
if (!result9.ok) {
  ...
  result9.errors.forEach(err => console.log(`    - ${err.path}: ${err.message}`));
} else {
  console.log("  ✗ FAILED: Should have found errors");
}
