...
(function (Op) {
    ...
    Op[Op["REFINE_POSITIVE"] = 25] = "REFINE_POSITIVE";
    Op[Op["REFINE_NEGATIVE"] = 26] = "REFINE_NEGATIVE";
    Op[Op["REFINE_NON_EMPTY"] = 27] = "REFINE_NON_EMPTY";
    // result/option combinators (Phase 1)
    Op[Op["RESULT_OK"] = 28] = "RESULT_OK";
    Op[Op["RESULT_ERR"] = 29] = "RESULT_ERR";
    Op[Op["OPTION_SOME"] = 30] = "OPTION_SOME";
    Op[Op["OPTION_NONE"] = 31] = "OPTION_NONE";
    // introspection metadata (Phase 1.2)
    Op[Op["METADATA"] = 32] = "METADATA";
    // effect types and ports (Phase 2)
    Op[Op["EFFECT"] = 33] = "EFFECT";
    Op[Op["PORT"] = 34] = "PORT";
    Op[Op["PORT_METHOD"] = 35] = "PORT_METHOD";
})(Op || (Op = {}));
export const enc = {
    str: () => [Op.STRING],
    num: () => [Op.NUMBER],
    ...
    refine: {
        ...
        // additional refinements (v0.8.0)
        positive: (t) => [Op.REFINE_POSITIVE, t],
        negative: (t) => [Op.REFINE_NEGATIVE, t],
        nonEmpty: (t) => [Op.REFINE_NON_EMPTY, t],
    },
    // result/option combinators (Phase 1)
    result: {
